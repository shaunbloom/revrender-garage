...
const RuckusFrontBlinkerMounts = ({
  ...
  return (
      <>
        <ProductTitle>Ruckus Front Blinker Mounts</ProductTitle>
        <Container>
        <ImageWrapper>
          <BackgroundImage
        ...
        <Description>
          ...
          <Links>
              ...
              <a href="https://amzn.to/3JVJwsq" target="_blank">
          ...
          <Notes>
              ...
              order the following kit. Two <a href="https://amzn.to/4mR0AOM" target="_blank">pairs
